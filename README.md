...
├── dia-de-muertos.html        # Día de los Muertos Ceremony: about, event recap stats, altar glossary, donors
...
- Every photo placeholder across the 6 new interior pages (`.ph-photo`) is a labeled dashed-border box, not a real image — About Us (4 photos + 9 board member headshots), Book Us (2 past-presentation photos), Contact (1 photo + 2 rep photos + 3 PR team photos), Dia de los Muertos (1 altar photo + 4 moment photos), Join Us (3 benefit-card photos), Donate/Gallery (placeholder grids). All need real photography before this goes further than a prototype.
